  ...
  return (
    <section className="py-24 bg-white" id="people">
      <div className="max-w-[1180px] w-[90%] mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 items-center">
        ...
        {/* PI Photo (Col 1 - 3 cols) */}
        <div className="lg:col-span-4">
          <div className="aspect-[4/5] rounded overflow-hidden shadow-lg border border-[#e3e8e9]">
            <img
        ...
        <div className="lg:col-span-4 space-y-4">
          ...
          <div>
            <div className="text-[#007681] font-extrabold text-lg uppercase tracking-wide">
          ...
          <p className="text-[#63666a] text-sm leading-relaxed">
            Dr Sewasew leads a multidisciplinary team of scientists, postdocs, and Ph.D. researchers advancing groundbreaking research at the frontiers of science, quantum dynamics, and biophysical technology.
          </p>
        ...
        <div className="lg:col-span-4 bg-[#f7f9f9] p-8 border border-[#e3e8e9] rounded space-y-6">
          ...
          <div className="grid grid-cols-3 gap-4">
            {teamMembers.slice(0, 6).map((member) => (
              <div
                ...
                className="cursor-pointer group flex flex-col items-center text-center space-y-1"
                title={member.name}
              >
                <div className="w-16 h-16 rounded-full overflow-hidden border-2 border-[#007681] group-hover:scale-110 transition-transform shadow-sm">
                  <img
                    src={member.avatar}
                    alt={member.name}
                    className="w-full h-full object-cover"
                ...
                <div className="text-[10px] font-bold text-[#102f38] group-hover:text-[#007681] line-clamp-1">
                  {member.name.split(' ')[0]}
                </div>
              </div>
            ))}
