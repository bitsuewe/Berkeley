      ...
      <div className="max-w-[1180px] w-[90%] mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-8 items-start">
        ...
        {collabItems.map((item, idx) => (
          <motion.div
            ...
            className="lg:col-span-3 border-l border-[#d4e0e2] pl-8 space-y-3 group hover:border-[#007681] transition-colors"
          >
            <div className="text-2xl text-[#007681] font-bold group-hover:scale-110 transition-transform origin-left">
              {item.icon}
            </div>
            ...
            <a href={item.href} className="text-link text-sm uppercase">
